...
def read_restore_revision(csv_path: Path) -> str:
    """Revision the raw active file so corrupt data can still be recovered."""
    try:
    ...
    def get_backups(self) -> None:
        try:
            with self.data_lock:
                ...
                revision = read_restore_revision(self.csv_path)
