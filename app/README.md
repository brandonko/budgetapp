...
Use **Import data** for Credit Karma, Venmo, Apple Card, and Capital One account
transactions, Amazon/AliExpress/eBay/Walmart order history, or Ledger-format CSV.
The companion Chrome extension supports all eight website sources; Apple Card
...
Date and a selected account identity. See the main README for supported layouts
