...
class DashboardEditFlowTests(unittest.TestCase):
    ...
    def test_summary_abbreviation_preference_controls_large_total_formatting(self) -> None:
        javascript = (ROOT / "app" / "app.js").read_text(encoding="utf-8")
        preferences = (ROOT / "app" / "preferences.js").read_text(encoding="utf-8")
        ...
        self.assertIn('window.addEventListener("ledger-number-abbreviation-change"', javascript)
        self.assertIn('"/preferences.js": APP_DIR / "preferences.js"', server)
