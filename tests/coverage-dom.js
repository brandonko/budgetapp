"use strict";
// Small dependency-free DOM surface for the read-only report controller.
class Element {
  constructor(tag = "div") { this.tagName = tag; this.children = []; this.listeners = {}; this.attributes = {}; this.value = ""; this.hidden = false; this.disabled = false; this.className = ""; this.style = {}; this._text = "";
