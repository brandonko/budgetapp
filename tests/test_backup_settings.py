...
class SettingsPageTests(unittest.TestCase):
    ...
    def test_classification_settings_explain_order_and_offer_export(self) -> None:
        ...
        self.assertIn('caption.textContent = "Notes"', javascript)
        self.assertIn('textarea.maxLength = 2000', javascript)
        self.assertIn('className = "classification-rule-notes-summary"', javascript)
        self.assertIn("Optional notes can explain why a rule exists", html)
        ...
        self.assertIn('/settings.js?v=20260902-rule-notes', html)
        self.assertIn('/styles.css?v=20260902-rule-notes', html)
