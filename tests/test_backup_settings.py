...
class SettingsPageTests(unittest.TestCase):
    ...
    def test_classifications_page_explains_order_and_offers_export(self) -> None:
        ...
        self.assertIn('id="import-classifications-button"', html)
        self.assertIn('id="import-classifications-input"', html)
        self.assertIn('accept="application/json,.json"', html)
        self.assertIn('id="export-classifications-button"', html)
        self.assertIn('fetch("/api/classifications/export"', javascript)
        self.assertIn('window.showSaveFilePicker', javascript)
        self.assertIn('suggestedName: "classifications.json"', javascript)
        self.assertIn('link.download = "classifications.json"', javascript)
        self.assertIn('elements.importClassificationsInput.click()', javascript)
        self.assertIn('JSON.parse(await file.text())', javascript)
        self.assertIn('This will replace the current classification library.', javascript)
